...
class tamanoPizza: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {

    @IBOutlet weak var pickerView: UIPickerView!
    var pickerDataSource = ["", "Pequeña (6 porc.)", "Mediana (8 porc.)", "Grande (10 porc.)","Familiar (12 porc.)"]
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        //rowF = pickerView.selectedRowInComponent(0)
        
        SharingManager.sharedInstance.tamanoPizza = pickerDataSource[row]
    }
